...
# Does not converge. Overcharged.  

summary(glmer_incomplete)


#Remove intercepts, does converge.
...
# The motivation to remove intercepts and keep slopes is that I assume that the correct voicing has an effect on item pairs and listeners. This is done to take into account that the voicing can be different for each item pair and listeners can perceive voicing differently. 
```
